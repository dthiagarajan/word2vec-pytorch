...
def load_data(filename, context_size, model_type = "skipgram", subsampling = False, sampling_rate = 0.001):
    with open(filename, "rb") as file:
        processed_text = word_tokenize(file.read().strip())
        processed_text, vocab, word_to_ix = gather_word_freqs(processed_text,
        ...
        return processed_text, vocab, word_to_ix, training_data
